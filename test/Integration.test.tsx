...
import { createSimpleStore as createReactStore, None as reactNone, useSimpleStore } from '../dist/react.js'
      ...
      function CartComponent() {
        ...
        return (
          <div>
            ...
            <button data-testid="add-apple" onClick={() => addItem({ id: '1', name: 'Apple', price: 1.5 })}>
              Add Apple
            </button>
            <button data-testid="add-banana" onClick={() => addItem({ id: '2', name: 'Banana', price: 0.8 })}>
              Add Banana
            </button>
          </div>
        )
